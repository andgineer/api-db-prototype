...
Frameworks like Connexion generate Python code from API specs. In this case you develop spec first and
gen autogenerated code from it. This approach is more suitable for large projects with many developers
